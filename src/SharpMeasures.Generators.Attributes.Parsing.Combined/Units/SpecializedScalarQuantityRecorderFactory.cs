...
public sealed class ExtendedUnitRecorderFactory : IExtendedUnitRecorderFactory
{
    ...
    /// <summary>Instantiates a <see cref="ExtendedUnitRecorderFactory"/>, handling creation of <see cref="ICombinedRecorder{TRecord}"/> for recording the arguments of <see cref="UnitExtensionAttribute{TOriginal}"/>.</summary>
    /// <param name="factory">The factory used to create <see cref="ICombinedRecorder{TRecord}"/>.</param>
    /// <param name="mapper">Provides mappings from the parameters of <see cref="UnitExtensionAttribute{TOriginal}"/> to recorders.</param>
