...
public interface IQuantityOperationRecorderFactory
{
    /// <summary>Creates a <see cref="ICombinedRecorder{TRecord}"/> recording the arguments of <see cref="QuantityOperationAttribute{TResult, TOther}"/>.</summary>
    ...
    public abstract ICombinedRecorder<IQuantityOperationRecord> Create(AttributeSyntax attributeSyntax);
}
