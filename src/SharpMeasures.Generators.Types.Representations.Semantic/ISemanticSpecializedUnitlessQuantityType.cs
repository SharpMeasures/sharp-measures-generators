...
/// <summary>Represents a unitless quantity, defined as a specialized form of another unitless quantity.</summary>
public interface ISemanticSpecializedUnitlessQuantityType : ISemanticSharpMeasuresType
{
    /// <summary>The <see cref="SpecializedUnitlessQuantityAttribute{TOriginal}"/> that marks the type as a specialized unitless quantity.</summary>
    public abstract ISemanticSpecializedUnitlessQuantityRecord SpecializedUnitlessQuantityDefinition { get; }
