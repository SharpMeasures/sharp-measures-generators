...
/// <summary>Represents a scalar quantity.</summary>
public interface ISemanticScalarQuantityType : ISemanticSharpMeasuresType
{
    /// <summary>The <see cref="ScalarQuantityAttribute{TUnit}"/> that marks the type as a scalar quantity.</summary>
    public abstract ISemanticScalarQuantityRecord ScalarQuantityDefinition { get; }
