...
/// <summary>Applied to SharpMeasures quantities, indicating that the implementing quantity supports conversion to and/or from the listed quantities.</summary>
...
public sealed class QuantityConversionAttribute : Attribute
{
    ...
    /// <summary>Dictates how the conversions from the implementing quantity to the provided quantities are implemented. The default behaviour is { <see cref="ConversionImplementation.Property"/> | <see cref="ConversionImplementation.Operator"/> }.</summary>
    ...
    /// <summary>Dictates how the conversions from the provided quantities to the implementing quantity are implemented. The default behaviour is { <see cref="ConversionImplementation.StaticMethod"/> | <see cref="ConversionImplementation.Operator"/> }.</summary>
    ...
    /// <inheritdoc cref="QuantityConversionAttribute"/>
