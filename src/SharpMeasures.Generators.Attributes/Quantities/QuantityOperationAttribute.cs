...
public sealed class QuantityOperationAttribute<TResult, TOther> : Attribute
{
    ...
    /// <summary>Dictates how the operation is implemented. The default behaviour is <see cref="OperationImplementation.All"/>.</summary>
    public OperationImplementation Implementation { get; init; }

    /// <summary>Dictates how the mirrored operation is implemented, if it is implemented. The default behaviour is <see cref="OperationImplementation.Operator"/>.</summary>
