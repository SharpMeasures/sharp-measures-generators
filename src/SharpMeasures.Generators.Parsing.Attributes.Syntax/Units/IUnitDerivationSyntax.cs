...
public interface IUnitDerivationSyntax : IAttributeSyntax
{
    ...
    /// <summary>The <see cref="Location"/> of the argument for the name of the method deriving the unit. May be <see cref="Location.None"/> if no argument was provided.</summary>
