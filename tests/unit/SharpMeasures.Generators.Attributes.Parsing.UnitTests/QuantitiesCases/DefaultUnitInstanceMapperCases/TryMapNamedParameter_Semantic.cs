...
public sealed class TryMapNamedParameter_Semantic
{
    ...
    public void Symbol_String_TryRecordArgumentReturnsTrueAndRecordsArgument()
    {
        ...
        var recorder = Target(Context.Mapper, SymbolName, recordBuilderMock.Object);
    ...
    {
        var recorder = Target(Context.Mapper, SymbolName, Mock.Of<ISemanticDefaultUnitInstanceRecordBuilder>());
    ...
    private static string SymbolName => nameof(DefaultUnitInstanceAttribute.Symbol);
}
