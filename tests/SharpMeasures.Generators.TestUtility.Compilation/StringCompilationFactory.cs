...
public static class StringCompilationFactory
{
    ...
    {
        if (localSources is null)
        {
            throw new ArgumentNullException(nameof(localSources));
        }

        if (foreignSources is null)
        {
            throw new ArgumentNullException(nameof(foreignSources));
        }
